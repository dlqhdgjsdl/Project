...
public class ShoseService extends Frame  implements TextListener,ActionListener{	
	...
	public void actionPerformed(ActionEvent e) {
		...
		try {
			oos.writeObject(ShoseService.this.nickname+"#"+msg);
	...
	public void initLayEx(String ip,String nickName) {
		...
		jbtn2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
			try {
				oos.writeObject(ShoseService.this.nickname+"#"+"exit");
			} catch (Exception e2) {
				// TODO: handle exception
			}
				System.exit(0);	
	...
	public ShoseService(String ip , String nickName) {
		this.nickname=nickName;
	...
	public void connect() {
		try {
			...
			ShoseCatThread sc = new ShoseCatThread(this);
			sc.start();
	...
	public static void main(String[] args) {
		new ShoseService("211.63.89.102","bongbong");
	}
