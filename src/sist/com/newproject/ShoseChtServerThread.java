...
public class ShoseChtServerThread extends Thread {
	private ShoseChtServer server;
	private String id;
	...
	public ShoseChtServerThread(ShoseChtServer server) {
		super();
		this.server=server;
	}
	public void broadCast(String message) {
		...
		for(ShoseChtServerThread t : server.getCollection()) {
